...
model_root = os.path.join('liftmodels', 'rgb_lift_model.pth')
...
model_ft.feature.classifier[5].register_forward_hook(for_hook)
...
if domain == 'source':
    feaname = 'rgb_'+phase+'_lift_features.npy'
else:
    feaname = 'hha_'+phase+'_lift_features.npy'
